...
pub const GL_KHR_debug = struct {
    ...
    pub fn debugMessageCallbackKHR(_callback: GLDEBUGPROCKHR, _userParam: ?*const c_void) void {
    ...
    pub fn objectPtrLabelKHR(_ptr: ?*const c_void, _length: GLsizei, _label: [*c]const GLchar) void {
        return (function_pointers.glObjectPtrLabelKHR orelse @panic("glObjectPtrLabelKHR was not bound."))(_ptr, _length, _label);
    }

    pub fn getObjectPtrLabelKHR(_ptr: ?*const c_void, _bufSize: GLsizei, _length: [*c]GLsizei, _label: [*c]GLchar) void {
    ...
    pub fn getPointervKHR(_pname: GLenum, _params: ?*?*c_void) void {
    ...
    pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?*c_void) !void {
        ...
        if (get_proc_address(load_ctx, "glDebugMessageControlKHR")) |proc| {
            ...
            log.emerg("entry point glDebugMessageControlKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glDebugMessageInsertKHR")) |proc| {
            ...
            log.emerg("entry point glDebugMessageInsertKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glDebugMessageCallbackKHR")) |proc| {
            ...
            log.emerg("entry point glDebugMessageCallbackKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glGetDebugMessageLogKHR")) |proc| {
            ...
            log.emerg("entry point glGetDebugMessageLogKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glPushDebugGroupKHR")) |proc| {
            ...
            log.emerg("entry point glPushDebugGroupKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glPopDebugGroupKHR")) |proc| {
            ...
            log.emerg("entry point glPopDebugGroupKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glObjectLabelKHR")) |proc| {
            ...
            log.emerg("entry point glObjectLabelKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glGetObjectLabelKHR")) |proc| {
            ...
            log.emerg("entry point glGetObjectLabelKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glObjectPtrLabelKHR")) |proc| {
            ...
            log.emerg("entry point glObjectPtrLabelKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glGetObjectPtrLabelKHR")) |proc| {
            ...
            log.emerg("entry point glGetObjectPtrLabelKHR not found!", .{});
            success = false;
        }
        if (get_proc_address(load_ctx, "glGetPointervKHR")) |proc| {
            ...
            log.emerg("entry point glGetPointervKHR not found!", .{});
            success = false;
        }
        if (!success)
...
const function_signatures = struct {
    ...
    const glDebugMessageCallbackKHR = fn (_callback: GLDEBUGPROCKHR, _userParam: ?*const c_void) void;
    ...
    const glObjectPtrLabelKHR = fn (_ptr: ?*const c_void, _length: GLsizei, _label: [*c]const GLchar) void;
    const glGetObjectPtrLabelKHR = fn (_ptr: ?*const c_void, _bufSize: GLsizei, _length: [*c]GLsizei, _label: [*c]GLchar) void;
    const glGetPointervKHR = fn (_pname: GLenum, _params: ?*?*c_void) void;
};
